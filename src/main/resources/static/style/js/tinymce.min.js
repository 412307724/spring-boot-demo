...
!function (e, t) {
    ...
    var s = {}, l = "tinymce/dom/Sizzle", c = "tinymce/html/Styles", d = "tinymce/dom/EventUtils",
        ...
        T = "tinymce/util/VK", R = "tinymce/dom/ControlSelection", A = "tinymce/dom/RangeUtils",
        B = "tinymce/dom/Selection", L = "tinymce/fmt/Preview", D = "tinymce/Formatter", M = "tinymce/UndoManager",
        H = "tinymce/EnterKey", P = "tinymce/ForceBlocks", O = "tinymce/EditorCommands", I = "tinymce/util/URI",
        F = "tinymce/util/Class", z = "tinymce/ui/Selector", W = "tinymce/ui/Collection", V = "tinymce/ui/DomUtils",
        ...
        et = "tinymce/ui/MessageBox", tt = "tinymce/WindowManager", nt = "tinymce/util/Quirks",
        rt = "tinymce/util/Observable", it = "tinymce/Shortcuts", ot = "tinymce/Editor", at = "tinymce/util/I18n",
        st = "tinymce/FocusManager", lt = "tinymce/EditorManager", ct = "tinymce/LegacyInput", dt = "tinymce/util/XHR",
        ut = "tinymce/util/JSON", ft = "tinymce/util/JSONRequest", pt = "tinymce/util/JSONP",
        mt = "tinymce/util/LocalStorage", ht = "tinymce/Compat", gt = "tinymce/ui/Layout",
